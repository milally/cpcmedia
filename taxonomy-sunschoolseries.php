<?php
/*
** template for CPC Sunday School Series taxonomy
** single-sermons.php
*/
...
<div id="primary">
   <div id="content" role="main">
     ...
     ?>
          <h2>Sunday School Series: <?php echo $term->name; ?></h2></br>
     ...
     <?php
       ...
       endwhile;
       ksort( $series_archive, SORT_NUMERIC ); //sorts the issue_archive array from high to low
       $myposts=array();
       foreach ( $series_archive as $rec_date => $postid ) {
         array_push($myposts,$postid);
       }
       $args = array(
         'post_type' => 'sun_school',
         'post__in' => $myposts
       );
